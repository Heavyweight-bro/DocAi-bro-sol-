...
- Пояснення впровадження для розробника в [docs/IMPLEMENTATION.uk.md](docs/IMPLEMENTATION.uk.md) і [довідник для компанії](docs/COMPANY_GUIDE.uk.md). Розділ «Впровадження» з інтерфейсу користувача прибрано.
- Після збереження API-ключа провайдер без ключа як default автоматично замінюється на щойно налаштованого (інакше кнопка обробки лишалась вимкненою).
