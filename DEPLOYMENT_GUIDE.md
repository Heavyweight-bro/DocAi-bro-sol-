...
Після відновлення перевіряють історію, шаблони, доступ і тестову обробку. Наступний етап — користувачі, ролі, серверна черга й журнал дій: [пояснення для компанії](docs/COMPANY_GUIDE.uk.md).
